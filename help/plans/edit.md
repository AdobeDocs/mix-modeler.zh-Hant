...
若要編輯計畫，請在 ![PLan](/help/assets//icons/FileChart.svg) **[!UICONTROL Plans]** 介面在Mix Modeler中，依名稱選取您的計畫。
...
1. 若要下載包含日期範圍劃分資料的CSV檔案，請選取「 」 ![下載](/help/assets//icons/Download.svg) **[!UICONTROL Download CSV]**. 從內容功能表：
   ...
   - 選取 ![下載](/help/assets//icons/Download.svg) **[!UICONTROL Detailed CSV]** CSV格式的詳細資料。
   - 選取 ![下載](/help/assets//icons/Download.svg) **[!UICONTROL Summary CSV]** CSV格式的摘要資料。
...
1. 若要編輯計畫，請選取 **[!UICONTROL Edit plan]**：
   ...
   1. 在 **[!UICONTROL Spend selection]** 區段，針對每個預算日期範圍，使用 ![V形](/help/assets//icons/ChevronRight.svg) 以開啟該資料範圍的管道分佈檢視。
   ...
   1. 若要在貨幣或百分比輸入之間切換，請選取 **[!UICONTROL $]** 或 **[!UICONTROL %]** 的 **[!UICONTROL View spend by]**.
      ...
      ![花費選取範圍](/help/assets//spend-selection.png)
   ...
   1. 若要編輯計畫的詳細資訊，請選取 **[!UICONTROL Edit details]**：
      ...
      1. 在 **[!UICONTROL Budget]** 區段：
         ...
         1. 修改 **[!UICONTROL Date range]** 輸入日期或使用選取日期範圍，以取得一或多個計畫的日期範圍 ![行事曆](/help/assets//icons/Calendar.svg).
      ...
      1. 選取 **[!UICONTROL Next]** 以返回 **[!UICONTROL Spend]** 區段。 選取 **[!UICONTROL Cancel]** 以返回您的計畫總覽。
         ...
         ![計畫詳細資訊](/help/assets//plan-details.png)
